...
export function generateSlots(
    ...
    // If the timezone conversion pushed the end time past midnight to the next local day,
    // ensure `end` is technically after `start` so the while loop runs.
