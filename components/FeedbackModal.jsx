...
export function FeedbackModal({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-black border border-green-200/20 text-stone-100 sm:max-w-3xl max-h-[85vh] overflow-y-auto no-scrollbar">
                <StarsBackgroundDemo />
                ...
                <div className="relative flex flex-col gap-5 mt-2">
                    ...
                    <div className="grid gap-3">
                        {[
                            {
                                icon: <Brain size={14} className="text-green-400" />,
                                label: "Technical",
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="bg-[#141417] border border-white/8 rounded-xl p-5">
                            <div className="flex items-center gap-2 mb-3">
                                <AlertCircle size={13} className="text-green-400" />
                                <p className="text-[10px] uppercase tracking-widest text-stone-500">
                                    To improve
                                </p>
                            </div>
