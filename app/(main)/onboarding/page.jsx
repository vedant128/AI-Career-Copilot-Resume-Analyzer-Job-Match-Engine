...
import { GrayTitle, GreenTitle, SectionLabel } from "@/components/reusables";
            ...
            <div className="w-full max-w-2xl">
                ...
                <div className="text-center mb-10">
                    ...
                    <h1 className="font-serif text-5xl leading-tight tracking-tighter mt-1">
                        ...
                        <br />
                        <GreenTitle>using Prept?</GreenTitle>
                    </h1>
                            ...
                            <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-2">
                                        <Label className="text-white" htmlFor="title">Current title</Label>
                                        <Input
