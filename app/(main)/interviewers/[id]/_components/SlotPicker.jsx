        ...
        <>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-7 flex flex-col gap-6">
                    ...
                    <div className="flex items-start justify-between gap-3">
                        ...
                        <div className="text-right shrink-0">
                            ...
                            <p className="font-serif text-2xl leading-none bg-linear-to-br from-green-300 to-green-500 bg-clip-text text-transparent">
                                {interviewerCredits}
                        ...
                        {dates.map((date) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span
                                        className={`mt-0.5 ${active ? "text-green-500/70" : "text-stone-700"
                                            }`}
                                    >
                                        {label.bottom}
                                    </span>
                                ...
                                return (
                                    <button
                                        ...
                                        className={`relative text-xs px-2 py-2.5 rounded-xl border transition-all duration-200 ${isSelected
                                            ? "border-green-400/60 bg-green-400/15 text-green-300 shadow-[0_0_12px_rgba(251,191,36,0.08)]"
                                            : slot.isBooked
                                                ? "border-white/5 bg-white/2 text-stone-700 cursor-not-allowed"
                                                : "border-white/10 text-stone-400 hover:border-green-400/30 hover:text-green-400 hover:bg-green-400/5 cursor-pointer"
                                            }`}
                                    >
                ...
                {selectedSlot && (
                    <div
                        ref={summaryRef}
                        className="bg-[#0f0f11] border border-green-400/20 rounded-2xl p-6 flex flex-col gap-4"
                    >
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <span className="font-serif text-lg bg-linear-to-br from-green-300 to-green-500 bg-clip-text text-transparent leading-none">
                                −{interviewerCredits}
                            </span>
                        </div>
                        <div className="flex justify-between text-xs">
