                ...
                <div className="relative max-w-6xl mx-auto px-8 pt-20 pb-14 flex flex-col gap-8">
                    ...
                    <div className="flex items-start gap-8">
                        <Avatar className="w-24 h-24 border-2 border-white/10 shrink-0 rounded-2xl">
                            ...
                            />
                            <AvatarFallback className="rounded-2xl bg-green-400/10 border border-green-400/20 text-green-400 text-3xl font-medium">
                                {interviewer.name?.[0] ?? "?"}
                            </AvatarFallback>
                        </Avatar>
                        <div className="flex flex-col gap-3 min-w-0 pt-1">
                            ...
                            <div className="flex items-center gap-2 flex-wrap mt-1">
                                ...
                                <Badge
                                    variant="outline"
                                    className="border-green-400/25 bg-green-400/8 text-green-400 text-xs px-3 py-1"
                                >
                        ...
                        <div className="bg-[#0f0f11] border border-white/10 rounded-2xl p-8 flex flex-col gap-5">
                            ...
                            <div className="flex flex-wrap gap-2.5">
                                {interviewer.categories.map((cat) => (
                                    <span
                                        key={cat}
                                        className="text-sm px-4 py-2 rounded-xl border border-green-400/20 bg-green-400/5 text-green-400"
                                    >
                        ...
                        <ul className="flex flex-col gap-5">
                            {EXPECT_ITEMS.map(([icon, title, desc]) => (
                                <li key={title} className="flex items-start gap-4">
                                    <span className="mt-0.5 w-10 h-10 shrink-0 rounded-xl bg-green-400/10 border border-green-400/20 flex items-center justify-center text-lg">
                                        {icon}
                                    </span>
